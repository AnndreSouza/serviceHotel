...
declare function local:transform($payload as element() (:: schema-element(trace:errorTrace) ::)) as element() (:: schema-element(fault:MandatoryParameterMissingFault) ::) {
    <fault:MandatoryParameterMissingFault>
      <trace:code>
